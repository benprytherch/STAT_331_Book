...
![](images/mod1_6.png){fig-align="left" width="220"}

![](images/mod1_7.png){width="339"}

![](images/mod1_8.png){fig-align="left" width="223"}

![](images/mod1_9.png){width="339"}
...
![](images/mod1_10.png){fig-align="right" width="200"}
...
Here, $t=3$ and p−value = 0.0133

$p< 0.05$, so reject $H_0$ and conclude that the sample means are "significantly different".
